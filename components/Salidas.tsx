...
const Salidas: React.FC<SalidasProps> = ({ user, salidas, onAddSalida, onUpdateSalida, onDeleteSalida }) => {
    ...
    const handlePrintCMR = (salida: Salida) => {
        ...
        alert(`Generando CMR para la salida ${salida.albaranSalidaId}.`);
    };
                            ...
                            {salidas.map((salida) => (
                                <React.Fragment key={salida.id}>
                                    <tr className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{salida.camionMatricula}</td>
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{salida.conductor}</td>
